...
const SignupForm = () => {
  ...
  async function onSubmit(values: z.infer<typeof SignupValidation>) {
    // once submitted, create a new user
  ...
  return (
    <Form {...form}>
      <div className="flex justify-center sm:w-420 flex-col items-center">
        <img src="/assets/images/logo.svg" alt="logo" />
        <h2 className="h3-bold md:h2-bold pt-5 sm:pt-12 text-center">
          Create a new account
        </h2>
        <p className="text-light-3 small-medium md:base-regulat mt-2">
